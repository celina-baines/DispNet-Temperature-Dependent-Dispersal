...
reading.path <- ("C:/Users/nikki/OneDrive - University of Toronto/PhD Research/Parasitism Content/Distributed Experiment/Distributed_Experiment/")
## set path for writing files (folder where you want output text files to go)
writing.path <- "C:/Users/nikki/OneDrive - University of Toronto/PhD Research/Parasitism Content/Distributed Experiment/Distributed_Experiment/outputs/" # make sure to end path with /
...
CODE CHUNK ADDED BY NIKKI - TESTING 
```{r writedata, echo = F}
