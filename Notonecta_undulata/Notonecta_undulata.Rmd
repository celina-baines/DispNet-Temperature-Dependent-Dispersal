...
fitness.transformation.function <- function(x) {return (sqrt(x))} # give transformation formula here; replace "log" with transformation used e.g., sqrt(x) or log(x + 1), etc., where x will be Fitness, below
...
fitness.formula <- "sqrt(Fitness) ~ Temp.treatment + (1|Mesocosm)"
