...
species.body.size <- 30 # mean body length in mm
...
*Gryllus campestris* were captured from semi-natural enclosures situated in Southern France (the Metatron, Ariège, France, 43°01ʹ N, 1°05ʹ E, Legrand et al 2012). 

**Life history information**  

*Gryllus campestris* are terrestrial orthopterans from the Gryllidae family, common over most of Western Europe. It is commonly found in dry grasslands. Individuals live for a year, and reproduce once a year.
The species is flightless and unable to disperse long distances, and has been classified as a low disperser in a study of dispersal abilities of Orthoptera species in Germany (Reinhardt et al 2005).
A test by the authors using individuals from the source populations and increasing temperature gradually degree by degree in a water bath until death gave a CTmax of 44.8°C +/- 1.44 SD (personal communication).
...
Beginning of September 2025, we captured 45 crickets from 8 semi-natural mesocosms (the Metatron), and brought them to the laboratory to study survival. Individuals were weighted, and then kept individually in 50 ml falcon tubes with a pierced lid, with a piece of humid cotton and dandelion leaves.
...
Once a week, the cotton was re-humidified, fresh dandelion leaves were added as food for the crickets.
...
Hence, for *Gryllus campestris*, the cut-off chosen led survival to be measured at 73 days of treatment.


### Phase 2: Dispersal assay

Dispersal assays were ran in 21 dispersal systems constituted by a plastic container (39*28*28 cm) connected to a 8 cm diameter plastic tube of total length 320 cm and composed of three tubes connected by U connectors, and ending in a pitfall trap (glass jar). The plastic tubes are cut in their length with a 3cm-large windows covered in insect net. 
The systems are filled with ground (organic compost), and departure patches contain dandelion leaves and carrot slices and a shelter made of egg cardboard. During the acclimation phase, corridors are closed by insect-proof net.
...
Crickets were captured from Metatron mesocosms end of September (~15 individuals per mesocosm in 7 mesocosms), acclimated to the laboratory for a few days, then we created 21 populations (7 populations per temperature) in the dispersal systems. We aimed to create populations of 5 individuals provening from the same Metatron mesocosm per dispersal system, but because we failed to capture enough individuals in some Metatron mesocosms, some dispersal systems contained less individuals than others.

Once populations were created in the dispersal systems, we left individuals to acclimatize to the departure patches for a day, then opened the corridors and monitored dispersal for 4 days, capturing dispersing individuals in the pitfall traps twice a day. During this period, systems (departure patches+ corridors) were sprayed with water daily. At the end of the dispersal experiment, we recaptured surviving and dead individuals.
