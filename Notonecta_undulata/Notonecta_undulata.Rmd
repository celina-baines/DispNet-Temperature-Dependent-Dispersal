...
transform.description <- "log10" # leave as-is if not applicable
...
Topt, Thot, and Tcold were set to 16, 26, and 30$^\circ$C, respectively. These temperatures were chosen based on the results of the fitness assay described below.
