...
fitness.formula.zero <- zero ~ Temp.treatment + (1|dispersion_id)
fitness.formula.pos <- Fitness ~ Temp.treatment + (1|dispersion_id)
...
dispersal.formula.zero <- zero ~ Temp.treatment + (1|dispersion_id)
dispersal.formula.pos <- cbind(Num.disp, Num.res) ~ Temp.treatment + (1|dispersion_id)
### notes
#### other.fixed.effects does not apply to every species; include as appropriate; fixed effects should be standardized
#### include as many random effects as appropriate
