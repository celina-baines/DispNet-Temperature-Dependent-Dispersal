...
group_name <- "column_name_for_population"
...
mixed.fitness <- TRUE/FALSE
mixed.dispersal <- TRUE/FALSE
...
Genus = "Genus"
species = "species"
fitness.proxy = "Population growth, r / Survival / Fecundity"
low.temp = x #value of low temperature treatment in Celsius
opt.temp = x #value of optimal temperature treatment in Celsius
high.temp = x #value of high temperature treatment in Celsius
...
taxonomic.group <- "arthropod/ciliate/microalgae"
rearing.environment <- "commonT/treatmentT/field"
comp.strength <- "low/moderate/high"
source <- "lab/field" # lab population or field caught
habitat <- "aquatic/terrestrial"
Tvariation <- "homogenous/heterogenous"
species.body.size <- x # mean body length in mm
passive.dispersal <- "Yes/No"
inbred <- "inbred line/mixed"
disp.assay.duration <- 0.01/0.1/1/10 # order of magnitude for dispersal assay duration / generation time, i.e., approximate number of generations the dispersal assay lasted
fitness.proxy.type <- "r/other"
...
```{r modeldiagnosticsfitness, eval = fitness.binary, echo = F, fig.width = 8, fig.height = 7}
