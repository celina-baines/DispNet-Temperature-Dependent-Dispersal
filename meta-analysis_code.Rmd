...
ggplot(subset(d_fitdispcontr, species != "Tetranychus.turkestani" & species != "Tetranychus.cinnabarinus"), aes(x = -es, y = OR, col = HILO))+
  geom_point()+
...
m_fitdispcontr <- lmer(OR ~ es*HILO + (1|Taxonomic.group/species), data = subset(d_fitdispcontr, species != "Tetranychus.turkestani" & species != "Tetranychus.cinnabarinus"))
summary(m_fitdispcontr)
drop1(m_fitdispcontr, test = "Chisq")


m_fitdispcontr_OH <- lmer(OR ~ es + (1|Taxonomic.group/species), data = subset(d_fitdispcontr, HILO == "hot" & species != "Tetranychus.turkestani" & species != "Tetranychus.cinnabarinus"))
