...
output: 
  word_document:
    toc: true
output_file: "../Knitted_Markdowns/Notonecta_undulata.docx"
editor_options: 
...
#setwd("C:/Users/nikki/OneDrive - University of Toronto/PhD Research/Parasitism Content/Distributed Experiment/DispNet-Temperature-Dependent-Dispersal/")
dir()

## set path for reading files (folder that contains the raw data files)
reading.path <- ("C:/Users/nikki/OneDrive - University of Toronto/PhD Research/Parasitism Content/Distributed Experiment/DispNet-Temperature-Dependent-Dispersal/Notonecta_undulata/")

#reading.path <- (paste("./", Genus, "_", species, "/", sep = ""))
#reading.path <- ("./")

writing.path <- ("C:/Users/nikki/OneDrive - University of Toronto/PhD Research/Parasitism Content/Distributed Experiment/DispNet-Temperature-Dependent-Dispersal/Notonecta_undulata/outputs/") # make sure to end path with /

#writng.path <- (paste("./",  Genus, "_", species, "/outputs/", sep = ""))

# trying alternatives to reading and writing paths
  #not finding dfs from this directory
#reading.path <- paste("./", Genus, "_", species, "/", sep = "") #specify folder in git repo
#writing.path <- paste("./", Genus, "_", species, "/", "outputs", sep = "") #specify folder in git repo
...
fitdf <- read.csv(paste(folder, fitpath, sep = "")) #read in fitness file from github path
dispdf <- read.csv(paste(folder, disppath, sep = "")) #read in dispersal file from github path
...
rmarkdown::render(paste(Genus, "_", species, "/", Genus, "_", species, ".Rmd", sep = ""), output_file = paste("Knitted_RMarkdowns/", Genus, "_", species,".docx", sep = ""))
#```