...
fitness.formula <- "Fitness ~ Temp.treatment + (1|plate)"
...
- Köln-3: Cologne, Germany. Rose
- Merc-1: Tarragona, Spain. Oleander
- Pora: Oradour, France. Greater celandine
- Sioure: Fontanès, France. Tomato
- Trio: Montpellier, France. Tomato


#How were individuals/populations treated before the experiment?  

- The mites were made isofemale lines, after which they were maintained under constant conditions as a stock. Food was ad libitum, temperature was kept at 24°C, and there was constant light.
...
# load data file
d_phase1 <- read.csv2(paste("Phase1_fitness_", Genus, ".", species, ".csv", sep = ""))
d_phase2 <- read.csv2(paste("Phase2_dispersal_", Genus, ".", species, ".csv", sep = ""))
...
# Make it work for populations with only dispersal in two Temp.treatments
