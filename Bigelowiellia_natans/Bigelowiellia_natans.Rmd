...
A previous experiment on the strain (Barton et al 19, doi:10.1002/lno.11170) estimated the thermal performance curve for growth of the species. The study used the SHarpe-Schoolfielld equation to calculate thermap performance curve parameters, with a Topt of 26.68°C, an activation energy Ea of 0.99 eV, a deactivation energy Eh of 4.59eV characterizing the decreases in rate above Th (302.01 °K) where half the enzymes have become nonfunctional , and  lnc the rate normalized to an arbitrary reference temeprature of 20°C is of -1.32.
