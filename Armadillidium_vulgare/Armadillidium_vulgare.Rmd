...
Genus = "Armadillidium"
species = "vulgare"
fitness.proxy = "Survival"
opt.temp = 18 #value of optimal temperature treatment in Celsius
medium.high.temp = 22 #value of high temperature treatment in Celsius
...
fitness.formula <- "Fitness ~ Temp.treatment  + (1|Mesocosm)"
...
species.body.size <- 15 # mean body length in mm
...
*Armadillidium vulgare* were captured from semi-natural enclosures situated in Southern France (the Metatron, Ariège, France, 43°01ʹ N, 1°05ʹ E, Legrand et al 2012). 

**Life history information**  

*Armadillidium vulgare* are terrestrial isopods of the Armadillidae family, native to Mediterranean Europe, but introduced in many other habitats since. They are gregarious, often found in moist habitats, although they are known to be resistant to low humidity. Their gregarious nature can lead to high densities of isopods, with up to 538 isopods per m2 found in one study (Paris and Pitelka 1962).
Individuals live for 2-3 and up to 4 years (Paris and Pitelka 1962), and females produce two to three broods per year. 
Individuals disperse by walking, and a study using radioactive tags has shown a maximum dispersal rate of 13 m in 12 hour in the summer and 10 m in six days in the winter, although most individuals were found within 2 meters from the point of release (Paris 1965).
The thermoprererendum of the species has been found to be between 22-23°C (Refinetti 1984), while a study showed a critical thermal maximum of 44.4 °C (Klok et al 2004).  
A test by the authors using individuals from the source populations and increasing temperature gradually degree by degree in a water bath until death gave a CTmax of 39.2°C +/- 1.56 SD (personal communication).
...
We studied survival as a function of temperature. 
Beginning of September 2025, we captured 120 isopods from 22 semi-natural mesocosms (the Metatron), and brought them to the laboratory to study survival. Individuals were weighted, and then kept individually in 50 ml falcon tubes with a pierced lid, with a piece of humid cotton and dry linden leaves.
...
Once a week, the cotton was re-humidified, and once every few weeks, when the leaves were close to consumed, the leaves were changed.
...
Hence, for *Armadillidium vulgare*, the cut-off chosen led survival to be measured at 49 days of treatment.


### Phase 2: Dispersal assay

Dispersal assays were ran in 48 dispersal systems constituted by a plastic container (39*28*28 cm) connected to a 8 cm diameter plastic tube of total length 320 cm and composed of three tubes connected by U connectors, and ending in a pitfall trap (glass jar). The plastic tubes are cut in their length with a 3cm-large windows covered in insect net. 
The systems are filled with ground (organic compost), and departure patches contain dry tree leaves and carrot slices and a shelter made of eggg cardboard. During the acclimation phase, corridors are closed by insect-proof net.
...
Isopods were captured from Metatron mesocosms end of September (~15 individuals per mesocosm in 16 mesocosms), acclimated to the laboratory for a few days, then we created 48 populations (16 populations per temperatures) the dispersal systems. We aimed to create populations of 5 individuals provening from the same Metatron mesocosm per dispersal system, but because some individuals died during the laboratory acclimation phase, some dispersal systems contained less individuals than others.

Once populations were created in the dispersal systems, we left individuals to acclimatize to the departure patches for a day, then opened the corridors and monitored dispersal for 13 days, capturing dispersing individuals in the pitfall traps twice a day. During this period, systems (departure patches+ corridors) were sprayed with water daily. At the end of the dispersal experiment, we recaptured surviving and dead individuals.
...
```{r fitnessplotnormal, eval = fitness.normal | fitness.transformed.normal, echo = F, message = F, fig.cap = paste("Figure 2. Boxplot of fitness (", tolower(fitness.proxy), "), as a function of temperature treatment. opt = ", opt.temp, "C, medium.high = ", medium.high.temp, "C, high = ", high.temp, "C.")}

# plot fitness data

ggplot(d_phase1, aes(x = Temp.treatment, y = Fitness, col = Temp.treatment))+
  geom_boxplot()+
  scale_x_discrete("Temperature treatment", limits = c("opt", "medium.high", "high"))+
...
```{r dispersalplot, echo = F, warning = F, fig.cap = paste("Figure 1. Dispersal as a function of temperature treatment. opt = ", opt.temp, "C, medium.high = ", medium.high.temp, "C, high = ", high.temp, "C. Error bars represent 95% confidence intervals predicted from GLMM.")}
