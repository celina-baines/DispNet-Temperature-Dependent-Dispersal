...
author: "Sarah Elliott, Chloe Guicharnaud, Celina Baines"
...
medium.low.temp = 22 #value of optimal temperature treatment in Celsius
opt.temp = 26 #value of high temperature treatment in Celsius
...
dispersal.formula <- "cbind(Num.disp, Num.nondisp) ~ Temp.treatment + (1|Group) + (1|Block)"
...
Conceptualization: Celina Baines, Chloe Guicharnaud   
Statistical analysis: Sarah Elliott, Chloe Guicharnaud   
Methodology (design of methodology): Sarah Elliott, Chloe Guicharnaud,
Celina Baines   
Investigation/conduct experiment: Sarah Elliott, Chloe Guicharnaud   
Funding acquisition: Celina Baines  
Writing (original draft, supplement): Sarah Elliott, Celina Baines   
Writing (review and editing): Chloe Guicharnaud

## Study organism

|      *Folsomia candida* Willem 1902 is a terrestrial arthropod present in soils across the globe. The average body size is 1.5-3.0mm at adult stages [@fountain2005] and they use active crawling as their dispersal mode. The species is generally short-lived with an average lifespan of 110 days at 20 °C and reaching sexual maturity around 10-25 days [@roeben2023]. The species reproduces asexually through parthenogenesis where embryos can develop from an unfertilized egg [@fountain2005]. 
|      For this experiment, we used individuals that were from an initial stock population sourced from the Soil Toxicology Laboratory at Environment of Climate Change Canada in November 2024. Populations were kept within a climatic chamber with conditions of 20 °C, 70 % Relative Humidity (RH), and 16:8 L:D cycle. Sub-populations from the initial stock were kept inside plastic containers filled with substrate consisting of plaster of Paris and charcoal (at an 8:1 ratio), which acts as artificial soil. In the laboratory, their diet consists of granulated bakers dried yeast. Water and food were replenished once per week as needed to ensure food supply was constant and organisms wouldn’t desiccate. 
|      Organisms used in the experiment were age-matched approximately a month prior to the start of the experiment during which they were kept within containers with substrate at 20 °C, 70 % Relative Humidity (RH), and 16:8 L:D cycle. Food and water were replenished once per week as needed. As traits related to dispersal are dependent on age and development stage in this system, age-matching was done to ensure *F. candida* were of the same age and instar at the start of an experiment. To do so, approximately 100 individuals were placed in
a clean container with a layer of substrate and left for 3 days.
Following a three-day egg-laying period, all adults were removed with
the eggs remaining. The eggs can hatch, grow and can be used
approximately one month after the initial adults were added.

## Study design

### Temperature treatments

|      For this experiment, T~Low.medium~ = 22°C, T~opt~ = 26°C, and T~low~ = 18°C. The optimal temperature was chosen based off literature which estimates the optimal temperature to be approximately 21°C [@snider2017]. A pilot was conducted to determine temperatures for T~opt~ and T~low~. For the pilot, temperatures ranging from 14-26°C with increments of 2°C were tested using number of offspring as a proxy for fitness. No temperatures above 26°C were chosen because eggs lose viability at 28°C [@fountain2005]. To assess number of offspring as a proxy for population growth, mesocosms were adjusted to each temperature and stock containers were added to each mesocosm a week prior to the start date. Five age matched individuals were placed in each replicate and allowed an egg laying period of three days. Following this period, adults were removed and populations of new adults were counted after approximately one month. From this we concluded 18°C and 26°C would be appropriate temperatures for T~low~ and T~opt~. Temperatures varied slightly around the three means of temperature treatments (18,22 and 26°C) with deviations of ± 1°C across all replicates and blocks.

### Phase 1: Fitness assay

|      For phase 1 of the experiment, we assessed growth rate as a proxy for fitness. We used 3D printed habitat nodes that have a round arena with a diameter of 3cm across. The arena has a layer of substrate and possible connections to other nodes. For this phase, all connections were blocked by cording fit to size of the connection holes. Water reservoirs are located at the base of the habitat nodes and were filled with 2 mL twice per week, an amount that previously has been demonstrated to be the optimal level of moisture. The water reservoir has holes which allows the substrate to absorb the water through capillary action. This prevents inconsistent water levels and reduces daily moisture variation. Additionally, petri dishes were placed on top of the nodes to maintain a constant humidity and to keep individuals within their respective node.   
|      Phase 1 was conducted in a climatic chamber set at 18°C, with consistent humidity and light cycle, similar to rearing conditions. The chamber had five spatially separated benches that were approximately 1 meter apart from each other and each bench could fit three mesocosms, therefore one from each treatment was placed on the bench to homogenize temperture treatments within the chamber. Mesocosms for 22°C and 26°C were fitted with heat mats along both sides and all mesocosms had a layer of insulation surrounding it. Mesocosm lids were constructed using a wooden frame and a semi-transparent plastic to ensure similar light conditions.   
|      Each mesocosm had three replicate nodes within it, and nodes remained in their respective mesocosm for the entirety of the experiment. No variance in fitness was attributed to mesocosms so the linear mixed model was simplified to a linear model. For acclimation, stock containers were added to each temperature treatment one week prior to the start of the experiment. At the start of the experiment, a total of 10 acclimated individuals were randomly added to each habitat node along with 2 pellets of food per node and water. Twice per week, old food was removed, and food (2+ pellets) and water (2 ml) were replenished. During the maintenance of the nodes, dead individuals were removed and noted, and pictures of nodes were taken so population size could be counted. Phase 1 of the experiment lasted a total of 28 days, which was based on the pilot and generation time of the lowest temperature group. The organism reproduces asexually, so no consideration was given to sex ratios, and no phenotypes were measured as a variable. 

### Phase 2: Dispersal assay
  
|      For Phase 2 of the experiment, we assessed dispersal of *F. candida* with discrete, two-node systems. We used the same 3D printed habitat patches as Phase 1; except we connected two nodes using clear Tygon tubing that was 8cm in length. Phase 2 was conducted in the same climatic chamber and mesocosms as Phase 1, but phase 2 took place shortly after phase 1 was conducted. For Phase 2, each mesocosm had three replicate two-node systems within it, and landscapes remained in their respective mesocosm for the entirety of the experiment.  
|      At the start of the experiment, a total of 100 acclimated and age-matched individuals were randomly added to each initial habitat node along with 6 pellets of yeast per initial node, 2 pellets of yeast per secondary node and 2 mL of water in every node. Twice per week, old food was removed, and food (6 and 2 pellets respectively) and water (2 mL) were replenished. Four days prior to phase 2, age matched stock populations that were different from those used in phase 1 were put in temperature regulated mesocosms to acclimate. Age-matched individuals were used because dispersal traits and ability in this system are correlated with age and body size. 
|      Phase 2 lasted 10 days, which was based on egg generation time in the highest temperature in order to prevent various density related effects on dispersal. Three times per week dispersal data was collected, where dispersers in the second node were counted, photographed and removed. Initial nodes were also photographed to collect population sizes throughout the experiment. Dead individuals were not removed from initial nodes during the experiment. However, we removed any individuals that died in the tubing to prevent mould impeding dispersal. The organism reproduces asexually, so no consideration was given to sex ratios, and no phenotypes were measured as a variable.
...
```{r fitnessplotnormal, eval = fitness.normal | fitness.transformed.normal, echo = F, message = F, fig.cap = paste("Figure 2. Boxplot of fitness (", tolower(fitness.proxy), "), as a function of temperature treatment. low = ", low.temp, "C, opt = ", medium.low.temp, "C, high = ", opt.temp, "C.")}

# plot fitness data

ggplot(d_phase1, aes(x = Temp.value, y = Fitness, col = Temp.treatment))+
  geom_boxplot()+
  scale_x_continuous("Temperature (degrees C)", breaks = c(18, 22, 26))+
  scale_color_manual(values = c("darkgreen", "red", "blue"), guide = "none")+
  theme_classic(base_size = 15)

```

`r ifelse(fitness.binary == T, print(paste("To estimate the effects of temperature (a factor) on fitness we used a generalized linear mixed model with a logit link and", tolower(fitness.proxy), "as the binary response variable. We used the formula:")), paste("To estimate the effects of temperature (a factor) on fitness, we used a linear model with", tolower(fitness.proxy), "as the response variable. We used the formula:"))`
...
```{r dispersalplot, echo = F, warning = F, fig.cap = paste("Figure 1. Dispersal as a function of temperature treatment. low = ", low.temp, "C, opt = ", medium.low.temp, "C, high = ", opt.temp, "C. Error bars represent 95% confidence intervals predicted from GLMM.")}
...
ggplot(as.data.frame(output_dispersal_emmeans$emmeans), aes(x = Temp.treatment, y = prob, col = Temp.treatment))+
  ...
  scale_x_discrete("Temperature treatment", limits = c("low", "opt", "high"), labels = c(18, 22, 26))+
...
There was no evidence for lack of fit for either the fitness or the
dispersal model.
